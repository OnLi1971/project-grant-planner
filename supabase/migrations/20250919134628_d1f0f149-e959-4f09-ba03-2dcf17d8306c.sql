-- Oprava bezpečnostních problémů

-- 1. Oprava normalizační funkce - přidat search_path
...
-- 2. Zrušit SECURITY DEFINER view a vytvořit znovu bez něj
DROP VIEW IF EXISTS planning_matrix;

-- 3. Vytvořit view znovu bez SECURITY DEFINER (RLS se použije podle volajícího uživatele)
