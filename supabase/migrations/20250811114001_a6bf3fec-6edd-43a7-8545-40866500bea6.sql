-- Import all 45 engineers with complete data (first part due to size limits)
DELETE FROM public.planning_entries;

-- Insert comprehensive planning data for first 25 engineers
INSERT INTO public.planning_entries (konstrukter, cw, mesic, mh_tyden, projekt) VALUES
-- Engineers from finalEngineers.ts 
...
-- Engineers from additionalEngineers.ts
