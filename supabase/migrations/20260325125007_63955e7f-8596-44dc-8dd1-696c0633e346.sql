...
BEGIN
  ...
  INSERT INTO engineers(display_name, slug, email, status, fte_percent, department_id, manager_id, company, hourly_rate, currency, location)
  VALUES (p_display_name, v_slug, p_email, p_status, COALESCE(p_fte,100), p_department, p_manager, p_company, p_hourly_rate, p_currency, COALESCE(p_location, 'PRG'))
  RETURNING * INTO v_row;

  RETURN v_row;
END $function$;

-- Update engineers_update RPC to accept p_location
